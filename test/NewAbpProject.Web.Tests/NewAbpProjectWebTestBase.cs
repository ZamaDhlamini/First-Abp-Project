...
{
    public abstract class NewAbpProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static NewAbpProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(NewAbpProjectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<NewAbpProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<NewAbpProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<NewAbpProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<NewAbpProjectDbContext, Task<T>> func)
        {
            T result;
