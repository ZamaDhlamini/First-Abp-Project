...
namespace NewAbpProject.Migrations
{
    ...
    partial class NewAbpProjectDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NewAbpProject.Domain.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NewAbpProject.Domain.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NewAbpProject.Domain.LectureModule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("LecturersModules", (string)null);
                });

            modelBuilder.Entity("NewAbpProject.Domain.Module", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NewAbpProject.Domain.Person", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Arf_Persons", (string)null);

                    b.HasDiscriminator<string>("Discriminator").HasValue("Person");
                });

            modelBuilder.Entity("NewAbpProject.Domain.RegisterModule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("RegisteredModules", (string)null);
                });
            ...
            modelBuilder.Entity("NewAbpProject.Domain.Employee", b =>
                {
                    b.HasBaseType("NewAbpProject.Domain.Person");
            ...
            modelBuilder.Entity("NewAbpProject.Domain.Lecture", b =>
                {
                    b.HasBaseType("NewAbpProject.Domain.Person");
            ...
            modelBuilder.Entity("NewAbpProject.Domain.Student", b =>
                {
                    b.HasBaseType("NewAbpProject.Domain.Person");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("NewAbpProject.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("NewAbpProject.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("NewAbpProject.Domain.LectureModule", b =>
                {
                    b.HasOne("NewAbpProject.Domain.Lecture", "Lecture")
                        .WithMany()
                        .HasForeignKey("LectureId");

                    b.HasOne("NewAbpProject.Domain.Lecture", "Module")
                        .WithMany()
            ...
            modelBuilder.Entity("NewAbpProject.Domain.Module", b =>
                {
                    b.HasOne("NewAbpProject.Domain.Course", "Course")
                        .WithMany()
            ...
            modelBuilder.Entity("NewAbpProject.Domain.RegisterModule", b =>
                {
                    b.HasOne("NewAbpProject.Domain.Module", "Module")
                        .WithMany()
                        .HasForeignKey("ModuleId");

                    b.HasOne("NewAbpProject.Domain.Student", "student")
                        .WithMany()
            ...
            modelBuilder.Entity("NewAbpProject.Domain.Employee", b =>
                {
                    b.HasOne("NewAbpProject.Domain.Department", "Department")
                        .WithMany()
